...
# 2kb analysis in c42
dss <- c(
  WT = "./source/genomewide_2kb_GRCh38_CpG_868_T1KO_WT_c42_GRCh38p12chrxymPARN.bed",
  KO1 = "./source/genomewide_2kb_GRCh38_CpG_868_T1KO_KO1_c42_GRCh38p12chrxymPARN.bed",
  KO2 = "./source/genomewide_2kb_GRCh38_CpG_868_T1KO_KO2_c42_GRCh38p12chrxymPARN.bed"
)
...
# Imprint
dss <- c(
  WT = "./source/hg38_imprint_DMRs_Court_liftover_CpG_868_T1KO_parent_c42_GRCh38p12chrxymPARN.bed",
  KO1 = "./source/hg38_imprint_DMRs_Court_liftover_CpG_868_T1KO_KO1_c42_GRCh38p12chrxymPARN.bed",
  KO2 = "./source/hg38_imprint_DMRs_Court_liftover_CpG_868_T1KO_KO2_c42_GRCh38p12chrxymPARN.bed"
)

fread("./source/hg38_imprint_DMRs_Court_liftover_CpG_868_T1KO_KO2_c42_GRCh38p12chrxymPARN.bed")
...
ggsave(filename = "edf12_d.pdf", width = 6, height = 6)
